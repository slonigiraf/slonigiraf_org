                ...
                <div className="isotopeContainer">
                    ...
                    <TabContent className="isotopeContainer" activeTab={activeTab}>
                        <TabPane className="row" tabId="1">
                            <Masonry breakpointCols={breakpointColumnsObj} className="my-masonry-grid row m-0 m-0" columnClassName="my-masonry-grid_column col-lg-4 col-md-6 col-12">
                        ...
                        <TabPane className="row" tabId="2">
                            <Masonry breakpointCols={breakpointColumnsObj} className="my-masonry-grid row m-0" columnClassName="my-masonry-grid_column col-lg-4 col-md-6 col-12">
